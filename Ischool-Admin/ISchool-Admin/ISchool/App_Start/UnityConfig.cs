...
namespace ISchool.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IGroupRepository, GroupRepository>(new PerRequestLifetimeManager());
            container.RegisterType<ILessonRepository, LessonRepository>(new PerRequestLifetimeManager());
            ...
            container.RegisterType<ILessonService, LessonService>(new PerRequestLifetimeManager());
        }
    }
}
